  ...
  <table class="table table-dark table-striped table-bordered table-hover">
    ...
    <?php 
      ...
      <tr>
        ...
        <td><a class="btn btn-sm btn-outline-danger" href='del.php?id=<?php echo $r['id']?>'>Delete</a></td>
        <td><a class="btn btn-sm btn-outline-success" href='update.php?id=<?php echo $r['id']?>'>Update</a></td>
      </tr>
      <?php } ?>
    </tbody>
  </table>
