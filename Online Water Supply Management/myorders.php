...
include("head2.php");
$sql="SELECT * from cnfrm_orders where order_by='$email' and status='Out for Delivery'";
  ...
  <table class="table table-dark table-striped table-bordered table-hover">
    ...
    <?php 
      ...
      <tr>
        ...
        <td><a class="btn btn-sm btn-outline-danger" href='cancel.php?id=<?php echo $r['order_id']?>'>Cancel Order</a></td>
    </tr>
      <?php } ?>
    </tbody>
  </table>
